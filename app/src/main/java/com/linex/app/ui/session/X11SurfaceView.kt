...
import com.linex.app.core.X11InputListener
    ...
    companion object {
        ...
        init {
            try {
                ...
                Log.i(TAG, "Native linex_engine library loaded for X11SurfaceView.")
            } catch (e: UnsatisfiedLinkError) {
                Log.w(TAG, "Native linex_engine library not loaded yet; JNI stubs active", e)
            }
        }
    }
