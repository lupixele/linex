...
class LinuxContainerService : Service() {
    ...
    override fun onCreate() {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Linex:ContainerWakeLock")
    }
    ...
    private fun buildNotification(title: String, content: String): Notification {
        ...
        return NotificationCompat.Builder(this, LinexApp.CHANNEL_ID)
